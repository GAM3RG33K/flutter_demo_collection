...
class GeneralUtils {
  ...
  static takeScreenshot(globalWidgetKey) async {
    ...
    var task = () {
      ...
      Future.delayed(Duration(seconds: 1), () async {
        ...
        File screenshot = File(filePath);
        await screenshot.writeAsBytes(pngBytes);
      });
    };
  ...
  /// This method will allow user to select a file form the storage
  ///
  static Future<String> selectFileWithPicker() async {}
}
